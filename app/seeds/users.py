...
def seed_users():
    ...
    Tiësto = User(first_name='Tijs', last_name='Verwest', work='Spinnin\' Records', location='North Brabant, Netherlands', education='Crestwood High School', email='tverwest@gmail.com', password='password', alias='Tiësto', cover_photo='', profile_pic='', birthday=datetime.date(1969, 1, 17), gender='Male')
    Michael = User(first_name='Michael', last_name='Jackson', work='MJJ Productions', location='Gary, IN', education='Ashbury High School', email='mjackson@gmail.com', password='password', cover_photo='', profile_pic='', birthday=datetime.date(1958, 8, 29), gender='Male')
    Chester = User(first_name='Chester', last_name='Bennington', work='Linkin Park', location='Palos Verdes Estates, CA', education='GOAT Academy', email='cbennington@gmail.com', password='password', alias='', cover_photo='', profile_pic='', birthday=datetime.date(1976, 3, 20), gender='Male')
    Mariah = User(first_name='Mariah', last_name='Carey', work='Butterfly MC', location='Huntington, NY', education='Harborfields High School', email='mcarey@gmail.com', password='password', alias='', cover_photo='', profile_pic='', birthday=datetime.date(1969, 3, 27), gender='Female')
    Gaga = User(first_name='Stefani', last_name='Germanotta', work='Monster Cable Products', location='New York City, NY', education='Tisch School of the Arts', email='sgermanotta@gmail.com', password='password', alias='Lady Gaga', cover_photo='', profile_pic='', birthday=datetime.date(1986, 3, 28), gender='Female')
    Kendrick = User(first_name='Kendrick', last_name='Lamar', work='Top Dawg Productions', location='Compton, CA', education='Centennial High School', email='klamar@gmail.com', password='password', alias='', cover_photo='', profile_pic='', birthday=datetime.date(1987, 6, 17), gender='Male')
    Billie = User(first_name='Billie', last_name='Eilish', work='Interscope Records', location='Los Angeles, CA', education='Homeschooled', email='beilish@gmail.com', password='password', alias='', cover_photo='', profile_pic='', birthday=datetime.date(2001, 12, 18), gender='Female')
