...
def seed_users():
    ...
    Kanye = User(first_name='Kanye', last_name='West', email='kwest@gmail.com', password='password', cover_photo='https://res.cloudinary.com/photofinder/image/upload/v1640149113/kanye%20profile/-1x-1_zdkdaf.jpg', profile_pic='https://res.cloudinary.com/photofinder/image/upload/v1640149112/kanye%20profile/2000_qpsl4j.jpg', birthday=datetime.date(1992, 9, 6), gender='Male')
