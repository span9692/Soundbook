...
def seed_friend_list():
    ...
    db.session.execute(friend_list.insert().values(friendAdder_id=1, friendReceiver_id=4, confirmed=True))
    db.session.execute(friend_list.insert().values(friendAdder_id=1, friendReceiver_id=5, confirmed=True))
    ...
    db.session.execute(friend_list.insert().values(friendAdder_id=1, friendReceiver_id=10, confirmed=True))
