...
def seed_friend_list():
    ...
    db.session.execute(friend_list.insert().values(friendAdder_id=2, friendReceiver_id=7, confirmed=False))
    db.session.execute(friend_list.insert().values(friendAdder_id=2, friendReceiver_id=8, confirmed=False))
    db.session.execute(friend_list.insert().values(friendAdder_id=2, friendReceiver_id=9, confirmed=False))
    db.session.execute(friend_list.insert().values(friendAdder_id=2, friendReceiver_id=10, confirmed=False))
