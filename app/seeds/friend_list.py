...
def seed_friend_list():
    ...
    db.session.execute(friend_list.insert().values(friendAdder_id=6, friendReceiver_id=2, confirmed=True))
    db.session.execute(friend_list.insert().values(friendAdder_id=2, friendReceiver_id=7, confirmed=True))
    db.session.execute(friend_list.insert().values(friendAdder_id=2, friendReceiver_id=8, confirmed=True))
    db.session.execute(friend_list.insert().values(friendAdder_id=2, friendReceiver_id=9, confirmed=True))
