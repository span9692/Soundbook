...
def seed_friend_list():
    ...
    db.session.execute(friend_list.insert().values(friendAdder_id=5, friendReceiver_id=2, confirmed=True))
    db.session.execute(friend_list.insert().values(friendAdder_id=16, friendReceiver_id=2, confirmed=True))
    db.session.execute(friend_list.insert().values(friendAdder_id=17, friendReceiver_id=2, confirmed=True))
    db.session.execute(friend_list.insert().values(friendAdder_id=18, friendReceiver_id=2, confirmed=True))
    ...
    db.session.execute(friend_list.insert().values(friendAdder_id=3, friendReceiver_id=8, confirmed=True))
